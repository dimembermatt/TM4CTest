...
int main(void) {
    /**
     * @brief This program, loaded onto the Analysis Chip, acts as a test
     * harness for the test program on the Test Chip. It manages communication
     * with the Test Chip, tells it when and how to perform relevant peripheral
     * tests, and collates the results into a human readable format for the
     * user. 
     */
